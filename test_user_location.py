...
print("3. AI agent calculates L-scores (Recency, Credibility, Spatial)")
print("4. User-provided location 'Mount Rainier, Washington' is saved to:")
print("   - location.name table")
print("   - local_lore.place_name field")
print("5. AI-extracted location is ignored (user location takes precedence)")
print()
print("="*80)
